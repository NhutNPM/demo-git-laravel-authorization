...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @can('post')
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_post"
                        aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-fw fa-newspaper"></i>
                        <span>Bài viết</span>
                    </a>
                    <div id="collapse_post" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                            <a class="collapse-item" href="{{ route('admin.post.index') }}">Danh sách</a>
                            {{-- @can('create', App\Model\Post::class) --}}
                            @can('post.add')
                                <a class="collapse-item" href="{{ route('admin.post.create') }}">Thêm mới</a>
                            @endcan
                        </div>
                    </div>
                </li>
            ...
            {{-- 
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_product"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-boxes"></i>
                    <span>Sản phẩm</span>
                </a>
                <div id="collapse_product" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.product.index') }}">Danh sách</a>
                        <a class="collapse-item" href="{{ route('admin.product.create') }}">Thêm mới</a>
                    </div>
                </div>
            </li> --}}
            ...
            @can('group')
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_group"
                        aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Nhóm người dùng</span>
                    </a>
                    <div id="collapse_group" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                            <a class="collapse-item" href="{{ route('admin.group.index') }}">Danh sách</a>
                            @can('group.add')
                                <a class="collapse-item" href="{{ route('admin.group.create') }}">Thêm mới</a>
                            @endcan
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapse_user" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @can('user.add')
                                <a class="collapse-item" href="{{ route('admin.user.create') }}">Thêm mới</a>
                            @endcan
                        </div>
                    </div>
                </li>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Nếu bạn bấm vào nút "Đăng xuất" bên dưới thì hệ thống sẽ kết thúc phiên làm
                    việc
                    của bạn.</div>
